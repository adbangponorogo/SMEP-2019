...
class Apisirup_model extends CI_Model {
	...
	public function getProgram($date, $dateEnd){
	...
	public function getKegiatan($date, $dateEnd){
	...
	public function getObjekAkun($date, $dateEnd){
	...
	public function getRincianObjekAkun($date, $dateEnd){
	...
	public function getPenyedia($date, $dateEnd){
	...
	public function getSwakelola($date, $dateEnd){
	...
	public function getPPK($date, $dateEnd){
	...
	public function getStrukturAnggaran($date, $dateEnd){
		$this->db->select("*");
